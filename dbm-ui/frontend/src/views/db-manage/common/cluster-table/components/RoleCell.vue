      ...
      <TextOverflowLayout>
        <div class="pr-4">
          <TextHighlight
            ...
            @highlight-hite="handleHightlightHite">
            <slot
              name="default"
              v-bind="{
...
<script setup lang="ts">
  ...
  const handleHightlightHite = () => {
    hightlightCount.value = hightlightRefs.value?.filter((item) => item.getHighlightHited()).length || 0;
  };
</script>
<style lang="less">
